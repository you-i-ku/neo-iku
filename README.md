...
| **環境刺激 + 鏡** | 毎セッション5プール（名詞69k/動詞14k/形容詞1.7k/数式/エントロピー）から1-3語を注入。環境語のembedding×行動メトリクスで「鏡」を生成し、ツール順序を変動させ`tool_actions.mirror`に記録。AIの行動が鏡を変え、鏡がAIの認知環境を変える循環構造 |
